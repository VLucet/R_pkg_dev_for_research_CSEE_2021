...
For now, it is important to note that the functions we just wrote are always explicit about using other functions by using the double dot notations to access functions that are contained in otehr packages.
