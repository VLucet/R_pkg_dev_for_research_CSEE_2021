...
---
## Packaging use case: the `roadrunner` package
<!-- emphasis on the shape of code not what all lines do -->

There are 2 things I love: __birding__ and __road-tripping__.

_Which eBird hotspots along my itinerary have the best chance to be harboring species I have never seen?_

The solution to this question has a lot of relevant steps to RSE in eco-evo:

1. Querying online data sources using an API key (eBird)

2. Dealing with spatial data

3. Repeating operations (for loop)
