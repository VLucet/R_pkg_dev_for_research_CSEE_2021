...
This is debated and sometimes difficult to achieve (for example with package that replicate a complex workflow). 
...
__Vignettes__ are an example of __long form documentation__. They are sued to introduce users to a package. 
...
The last nice thing that GA can do for us is set up a website for the documentation of our package, deployed by Actions and hosted of GitHub Pages.
...
[It will build the binaries for windows and MacOs](https://vlucet.r-universe.dev/ui#builds). 
...
On all platforms and and R versions (including R-devel) without trigerring any error, warnings or significant notes. 
...
The most rigorous process an R package can go through for publication.
