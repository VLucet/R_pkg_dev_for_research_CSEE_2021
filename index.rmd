---
title: .left[R Package Development for Research]
subtitle: .left[_An Introduction_]
author: 
  - .left[Valentin Lucet]
date: .left[`r Sys.Date()`]
output:
...
The 3 most pupular types of OOP frameworks in R<sup>1</sup> :
...
Which one to choose? Many trade-offs excists. In a nutshell: __choose S3 for simplicity, S4 for rigor and R6 if you need mutability__.
